...
const Settings = () => {
	const [settings, setSettings] = useState(["Industry",  "Investment Description", "Investment Demographic", "Fundraising Stage", "Investment Region", "Venture Experience", "Investment Range", "Investment Check Size"]);
	...
	const PreferencesForm = () => {
		...
		<form className="register-form" onSubmit={handleSubmit(onSubmit)}>
			<div className="form-group z-index-5">
				<Controller
					name="industries"
					control={control}
					render={({ field }) => {
			...
			<div className="form-group z-index-4">
				<Controller
	...
	return (
		<div className={classNames(`container-app settings`)}>
			...
			<h5>
				Please enter in and rank the attributes which matter to you most in a VC below. Our algorithm will use this to recommend
			...
			<Button className="button-last" onClick={() => signOutHandler()}>Sign Out</Button>
