...
const ActionButtons = () => {
	...
	return (
		<div className="action-buttons">
			<div
				className="action-button action-button-hover-parent"
				onMouseEnter={() => setIsMatchShown(true)}
				onMouseLeave={() => setIsMatchShown(false)}>
				...
				{isMatchShown && (
					<div className="action-button-hover-text">
						<p>Match</p>
					</div>
				)}
			</div>
			<div
				className="action-button action-button-hover-parent"
				onMouseEnter={() => setIsAlreadyTalkingShown(true)}
				onMouseLeave={() => setIsAlreadyTalkingShown(false)}>
				<button className="action-button-image">
					<Image
			...
			<div
				className="action-button action-button-hover-parent"
				onMouseEnter={() => setIsDenyShown(true)}
				onMouseLeave={() => setIsDenyShown(false)}>
				<button className="action-button-image">
					<Image
