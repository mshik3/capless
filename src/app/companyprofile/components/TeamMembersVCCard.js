				...
				<div className="team-members-container">
					<div className="team-column">
						<Image
							...
							src={require(`../../../assets/images/team_images/Rebecca Sanford.jpeg`)}
						/>
					...
					<div className="team-column">
						<Image
							className={"team-image"}
							src={require(`../../../assets/images/team_images/Tony Morrow.jpeg`)}
						/>
					...
					<div className="team-column">
						<Image
							className={"team-image"}
							src={require(`../../../assets/images/team_images/Rodney Clark.jpeg`)}
						/>
