...
import { industries, investment_demographic, investment_description } from "./constants";
...
const InvestorForm = (data) => {
	...
	const atLeastOne = (name) => (getValues(name).length ? true : "Please choose atleast 1 option.");
	...
	const onSubmit = (data) => {
		...
		UpdateUser(username, "investor", data);
						...
						return (
							<div>
								...
								<Select
									...
									options={investment_demographic}
									isMulti
									{...field}
								/>
							</div>
